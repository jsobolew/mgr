...
/net/tscratch/people/plgjsobolewski/conda_env/bin/python ../run_experiment.py project="rehersal ResNet CIFAR10 Task IL" setup="taskIL" learning_rate="0.003" architecture="ResNet18" dataset="CIFAR10" rehearsal_dataset="stylegan-highfreq" epochs="5" batch_size_rehearsal="128" batch_size="128" pretraining="True" num_classes="10" classes_per_task="2" optimizer="SGD" &
/net/tscratch/people/plgjsobolewski/conda_env/bin/python ../run_experiment.py project="rehersal ResNet CIFAR10 Task IL" setup="taskIL" learning_rate="0.003" architecture="ResNet18" dataset="CIFAR10" rehearsal_dataset="stylegan-highfreq" epochs="5" batch_size_rehearsal="128" batch_size="128" pretraining="True" num_classes="10" classes_per_task="2" optimizer="SGD" &
/net/tscratch/people/plgjsobolewski/conda_env/bin/python ../run_experiment.py project="rehersal ResNet CIFAR10 Task IL" setup="taskIL" learning_rate="0.003" architecture="ResNet18" dataset="CIFAR10" rehearsal_dataset="stylegan-highfreq" epochs="5" batch_size_rehearsal="128" batch_size="128" pretraining="True" num_classes="10" classes_per_task="2" optimizer="SGD" &
/net/tscratch/people/plgjsobolewski/conda_env/bin/python ../run_experiment.py project="rehersal ResNet CIFAR10 Task IL" setup="taskIL" learning_rate="0.003" architecture="ResNet18" dataset="CIFAR10" rehearsal_dataset="stylegan-highfreq" epochs="5" batch_size_rehearsal="128" batch_size="128" pretraining="True" num_classes="10" classes_per_task="2" optimizer="SGD" &
/net/tscratch/people/plgjsobolewski/conda_env/bin/python ../run_experiment.py project="rehersal ResNet CIFAR10 Task IL" setup="taskIL" learning_rate="0.003" architecture="ResNet18" dataset="CIFAR10" rehearsal_dataset="stylegan-highfreq" epochs="5" batch_size_rehearsal="128" batch_size="128" pretraining="True" num_classes="10" classes_per_task="2" optimizer="SGD" 